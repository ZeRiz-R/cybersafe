...
@onready var message_wrapper: Control = $Wrapper/VBoxContainer/IconMessageContainer/MessageBoxWrapper/MessageWrapper
...
@onready var typing_wrapper: Control = $Wrapper/VBoxContainer/IconMessageContainer/MessageBoxWrapper/TypingWrapper
...
@onready var avatar_wrapper: Control = $Wrapper/VBoxContainer/IconMessageContainer/AvatarWrapper
...
func connect_message(chatMessage: ChatMessage):
	...
	if chatMessage.isPlayerMessage:
		...
		icon_message_container.size_flags_horizontal = Control.SIZE_SHRINK_END
		typing_wrapper.size_flags_horizontal = Control.SIZE_SHRINK_END
...
func hide_sender_info():
	sender.modulate.a = 0.0
	avatar_wrapper.visible = false
